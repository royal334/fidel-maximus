...
function Services() {
     ...
     { id:3, title: "Fidel Assets and Properties", description: "Buying lifetime appretiating assets", img: "assets-and-props.png", alt: "Service One", instagramurl: "https://www.instagram.com/fidel_asset_and_properties?igsh=MWlxZXNvejNxaDZnNw%3D%3D&utm_source=qr", tiktokurl:'https://www.tiktok.com/@fidelassetandproperties?_t=ZM-8x5Pk6Vv7xu&_r=1',  facebookurl:'https://www.facebook.com/share/1AmtCFYHzZ/?mibextid=wwXIfr'}
     ]
